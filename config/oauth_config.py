...
# ONLINE
CLIENT_ID = "fa8f0088-ea6b-4ee1-910c-bea0973d361d"  # Application (client) ID of app registration
CLIENT_SECRET = "Ywv7Q~YajLuO8Yxaqhtjq~mL5MuMaRcUuWB9Z"  # Placeholder - for use ONLY during testing.
